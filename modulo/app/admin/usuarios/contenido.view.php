            ...
            <nav>
                ...
                <div class="row">
                    ...
                    <div class="col-9 d-flex justify-content-end ml-1">
                        <a href="../../cerrar.php" class="d-flex align-self-center cerrar-sesion">Cerrar Sesión</a>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                ...
                                <img class=" img-fluid my-2" src="../../../../img/avatar-red.svg" alt="" style="height: 100px;">
                ...
                <div class="col-12">
                    <div class="tab-content" id="v-pills-tabContent">
                        ...
                        <div class="tab-pane fade show active texto	" id="v-pills-home" role="takbpanel" aria-labelledby="v-pills-home-tab">
                            <div class="row">
                                <div class="col-12">
                                    <h1 class="text-center texto-usuarios p-2">Bienvenido al Sistema</h1>
                                    <!-- ***Mensaje Bienvenida** -->
                                ...
                                <div class="row my-5 mx-3 shadow">
                                    ...
                                    <div class="col-md-3 d-flex  mt-1 d-flex justify-content-center">
                                        <img class="img-fluid p-3 " src="../../../../img/logo.png" alt="" style="height: 250px;">
                                    </div>
