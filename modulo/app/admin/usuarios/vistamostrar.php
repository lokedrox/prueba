        ...
        <tbody>
          ...
          foreach ($usuarios as $usuario) {
            echo "<tr >" .
              ...
              "<td class=' pt-4'>" . $usuario["usuario_empleado"] . "</td>" .
              "<td class=' pt-4'>" . $usuario["contra_empleado"] . "</td>" .
              "<td class=' pt-4'>" . $usuario["id_empleado"] . "</td>" .
              "<td class=' pt-4'>" . $usuario["nivel_acceso"] . "</td>" .
              "<td class=' pt-4'>" . $usuario["estado"] . "</td>" .
              ...
              "<a href='?action=eliminar&id_empleado=" . base64_encode($usuario["id_empleado"]) .
