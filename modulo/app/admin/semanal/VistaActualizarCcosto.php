...
<body>
    ...
    <div class="container-fluid mx-md-1">
        <div class="d-flex justify-content-center ">
            ...
            <form action="?action=actualizarCcosto" method="post" class="container contenedor-guardar-usuarios animacion-lateral pl-md-5 pt-md-4">
                ...
                <br>
                <center>
                    <a type="submit" name="boton" class="btn btn-success   my-2 p-2" href="?action=mostrarCcosto">
