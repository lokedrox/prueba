...
<body>
  ...
  <div class="container-fluid px-md-3 animacion-lateral">
    ...
    if ($tam == 0) {
      echo "<br><p><strong>No se encontro registro de productos!!</strong></p>";
    } else {
    ...
    ?>
      ...
      <table class="table table-striped py-3 table-hover table-borderless mb-4 pb-5" id="tabla">
        ...
        <thead class="thead-dark ">
          ...
          <th class="py-3">Nombre Producto</th>
          <th class="py-3">Precio Producto</th>
          <th class="py-3">Cantidad Producto</th>
          <th class="py-3">Id Categoria</th>
        ...
        <tbody>
          ...
          foreach ($usuarios as $usuario) {
            echo "<tr >" .
              ...
              "<td class=' pt-4'>" . $usuario["nom_producto"] . "</td>" .
              "<td class=' pt-4'>" . $usuario["pre_producto"] . "</td>" .
              "<td class=' pt-4'>" . $usuario["cant_producto"] . "</td>" .
              "<td class=' pt-4'>" . $usuario["id_categoria"] . "</td>" .
              "<td class=' pt-4'>" . $usuario["deta_producto"] . "</td>" .
              ...
              "<a href='?action=eliminar&id_producto=" . base64_encode($usuario["id_producto"]) .
