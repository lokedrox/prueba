                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                ...
                                <a class=" nav-link p-3 active" href="#"><i class="fas fa-truck icono"></i> Proveedores</a>
                ...
                <div class="col-12">
                    <div class="tab-content" id="v-pills-tabContent">
                        ...
                        <div class="tab-pane fade show active texto	" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                            <div class="row">
                                <div class="col-12">
                                    <h1 class="text-center texto-usuarios p-2  ">Proveedores</h1>
                                    <!-- ***OPCIONES DENTRO DE Proveedores (CRUD)** -->
